...
export const products: Product[] = [
  // ————— İÇECEK ÖZLERİ (1/4) —————
  {
    ...
    bottleImage: "/img/urun-limonata.webp",
    orchardImage: "/img/bahce-limon.webp",
    isPlaceholder: false,
  },
  {
    ...
    bottleImage: "/img/urun-mandalina.webp",
    orchardImage: "/img/bahce-mandalina.webp",
    isPlaceholder: false,
  },
  {
    slug: "karadut-suyu",
    ...
    bottleImage: "/img/urun-karadut.webp",
    orchardImage: null,
    isPlaceholder: false,
  },
  ...
  // ————— MEYVE SULARI (içime hazır) —————
  {
    ...
    bottleImage: "/img/urun-portakal.webp",
    orchardImage: "/img/bahce-portakal.webp",
    isPlaceholder: false,
  },
  {
    slug: "greyfurt-suyu",
    ...
    bottleImage: "/img/urun-greyfurt.webp",
    orchardImage: null,
    isPlaceholder: false,
  },
  {
  ...
  // ————— PROFESYONEL KULLANIM —————
  {
    ...
    bottleImage: "/img/urun-limon-suyu.webp",
    orchardImage: "/img/lamas-limon.webp",
    isPlaceholder: false,
  },
];
